...
def novo_processo():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            categoria = cursor_dict.fetchone()
            ...
            # Fechamos os dois cursores que abrimos nesta rota
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            if origem == 'calendario':
                # Corrigi aqui também para apontar para a blueprint de tarefas que criamos
